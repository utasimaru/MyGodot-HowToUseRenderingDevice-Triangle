...
public partial class CustomPipeline : CompositorEffect
{
    RenderingDevice rd;
    Rid pipeline;
    Rid shader;
    ...
    public void _initialize_rendering(RenderSceneBuffersRD renderscene_buffers)
    {
        ...
        RDShaderFile shader_file = GD.Load<RDShaderFile>("res://triangle.glsl");
        RDShaderSpirV shader_spirv = shader_file.GetSpirV();
        shader = rd.ShaderCreateFromSpirV(shader_spirv);
        ...
        var vertices_position_packed = new byte[vertices.Length * sizeof(float)];
        Buffer.BlockCopy(vertices, 0, vertices_position_packed, 0, vertices_position_packed.Length);
        ...
        var vertices_color_packed = new byte[colors.Length * sizeof(float)];
        Buffer.BlockCopy(colors, 0, vertices_color_packed, 0, vertices_color_packed.Length);
        var vertices_color_buffer = rd.VertexBufferCreate((uint)vertices_color_packed.Length, vertices_color_packed);
    ...
    public override void _RenderCallback(int effectCallbackType, RenderData renderData)
    {
        ...
        if (effectCallbackType == ((int)EffectCallbackTypeEnum.PostTransparent)) {
            ...
            if (render_scene_buffers != null) {
                ...
                rd.DrawCommandBeginLabel("Draw a triangle", new Godot.Color(1.0f, 1.0f, 1.0f, 1.0f));

                var draw_list = rd.DrawListBegin(screen_buffer, RenderingDevice.DrawFlags.ClearColor0, clear_colors);
